        ...
        <div class="footer-top-container">
            <div class="footer-top">
                <div class="footer-top-list">
                    <ul>
                        <li><img src="../../img/user/footer/image1.png"></li>
                        <li><img src="../../img/user/footer/image2.png"></li>
                        <li><img src="../../img/user/footer/image3.png"></li>
                        <li><img src="../../img/user/footer/image4.png"></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="footer-bottom">
                    <div class="bottom-inner">
                        <div class="footer-left">
                                <img src="../../img/user/footer/support.png">
                        ...
                        <div class="footer-awards">
                            <ul>
                                <li>
                                <img src="../../img/user/footer/image1 (6).png">
                                </li>
                                <li>
                                <img src="../../img/user/footer/image2 (5).png">
                                </li>
                                <li>
                                <img src="../../img/user/footer/image3 (4).png">
                                </li>
                                <li>
                                <img src="../../img/user/footer/image4 (3).png">
                                </li>
                                <li>
                                <img src="../../img/user/footer/image5 (3).png">
                                </li>
                                <li>
                                <img src="../../img/user/footer/image6 (2).png">
                                </li>
                            </ul>
                        </div>
                    </div>
